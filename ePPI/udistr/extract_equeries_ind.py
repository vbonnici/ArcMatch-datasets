...
i_o_prefix = sys.argv[5]			#path... odir/name_*  0.gfd, 1.gfd
i_o_suffix = sys.argv[6]			#.efgd
...
def extract_subgraph(inet, available_nodes, name, nof_nodes, is_directed):
    """
...
for i in range(i_nof_subgraphs):
    ...
    print('subgraph',i)
    sg, nmap = extract_subgraph(inet, av_nodes, inet.name +'_sub_'+ str(i), i_nof_nodes, i_directed)
